...
const Navbar = () => {
  ...
  return (
    <nav className='bg-white px-48 w-full fixed z-20 py-3 flex justify-between items-center border-b border-gray-200 shadow-[0_35px_35px_rgb(0_0_0_/_0.04)]  '>
        ...
        <ul className='flex justify-center items-center gap-8'>
            ...
            <li className={`text-sm font-medium py-1 px-2 cursor-pointer ${pathname === '/contact' ? 'border-b-2 border-primary text-primary' : ''}`}><Link href={'/contact'}>Contato</Link></li>
        </ul>
    </nav>
  )
}
