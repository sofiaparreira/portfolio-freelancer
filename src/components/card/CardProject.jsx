...
const CardProject = ({ title, description, image, link, isFeatured, stack, date, client, onClick }) => {
  return (
    <div onClick={onClick} className='flex flex-col  group border border-gray-100 shadow-lg shadow-gray-200 rounded-lg cursor-pointer transition duration-300 ease-in-out hover:-translate-y-2 '>
